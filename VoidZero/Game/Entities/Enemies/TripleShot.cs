...
namespace VoidZero.Game.Entities.Enemies
{
    public class TripleShot : Enemy
    {
        ...
        public TripleShot(Texture2D texture, Vector2 position, BulletManager bulletManager, BulletEnergy energy)
            : base(texture, position, 24, 24)
        {
            ...
            _shooter = new ShooterComponent(
                new SpreadPattern(bulletTex, Vector2.UnitY, 3, 30f, 500f),
                bulletManager,
                BulletOwner.Enemy,
                cooldown: 1.0f,
                damage: 1f
